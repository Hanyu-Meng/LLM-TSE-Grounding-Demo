...
CASES = {
    "clean-case-segmented.png": [
        ...
        (CLEAN_AUDIO / "segmented" / "primary.wav", "BSRNN-TSE", "wrong speaker · WER 100%", MUTED),
        (CLEAN_AUDIO / "segmented" / "pool-d.wav", "BSRNN-TSE-CDCS-5", "middle view · WER 0%", ORANGE),
    ],
    "noisy-case-evidence-repair.png": [
        (NOISY_AUDIO / "evidence-repair" / "target.wav", "Clean target", "evaluation only", BLUE),
        (NOISY_AUDIO / "evidence-repair" / "primary.wav", "BSRNN-TSE", "wrong speaker · WER 144.44%", MUTED),
        (NOISY_AUDIO / "evidence-repair" / "cdcs-5.wav", "BSRNN-TSE-CDCS-5", "target recovered · WER 11.11%", ORANGE),
    ...
    "noisy-case-speaker-grounding.png": [
        ...
        (NOISY_AUDIO / "speaker-grounding" / "cdcs-5.wav", "BSRNN-TSE-CDCS-5", "repaired evidence · WER 16.67%", ORANGE),
        (NOISY_AUDIO / "speaker-grounding" / "qwen-ud.wav", "Qwen-TSE-UD", "speaker collapse · WER 100%", MUTED),
        (NOISY_AUDIO / "speaker-grounding" / "qwen-fixed-csg.wav", "Qwen-TSE-fixed-CSG", "speaker restored · WER 25%", GREEN),
    ],
    "noisy-case-content-grounding.png": [
        (NOISY_AUDIO / "content-grounding" / "target.wav", "Clean target", "evaluation only", BLUE),
        (NOISY_AUDIO / "content-grounding" / "cdcs-5.wav", "BSRNN-TSE-CDCS-5", "repaired evidence · WER 0%", ORANGE),
        (NOISY_AUDIO / "content-grounding" / "qwen-ud.wav", "Qwen-TSE-UD", "transcript agreement · WER 0%", MUTED),
    ...
    "noisy-case-quality-grounding.png": [
        ...
        (NOISY_AUDIO / "quality-grounding" / "cdcs-5.wav", "BSRNN-TSE-CDCS-5", "WER 0% · UTMOS 1.31", ORANGE),
